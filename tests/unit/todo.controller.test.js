...
const todoId = "680b3eed7a54bab78dc669d1"
...
describe("TodoController.getTodoById", () => {
    ...
    it("should call TodoModel.findById with route parameters", async () => {
        req.params.todoId ="680b3eed7a54bab78dc669d1";
        await TodoController.getTodoById(req, res, next);
        expect(TodoModel.findById).toBeCalledWith("680b3eed7a54bab78dc669d1");
    })
...
describe("TodoController.deleteTodo", () => {
    ...
    it("should delete with TodoModel.findByIdAndDelete", async () => {
      ...
      it("should return a response code 200", async () => {
        req.params.todoId = todoId;
        const deletedTodo = { _id: todoId, title: "Sample", done: false };
